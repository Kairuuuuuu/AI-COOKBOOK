...
public class MainMenu {
    ...
    public static void showMenu() {
        JFrame frame = new JFrame("Dirk's CookBook - Main Menu");
        ...
        card2.add(f1Title);
        JLabel f1Cal = new JLabel("📊 450 cal | 35g Pro", SwingConstants.CENTER);
        f1Cal.setFont(new Font("SansSerif", Font.PLAIN, 9));
        f1Cal.setBounds(15, 145, 90, 15);
        card2.add(f1Cal);
        ...
        card2.add(f2Title);
        JLabel f2Cal = new JLabel("📊 350 cal | 35g Pro", SwingConstants.CENTER);
        f2Cal.setFont(new Font("SansSerif", Font.PLAIN, 9));
        f2Cal.setBounds(117, 145, 90, 15);
        card2.add(f2Cal);
        ...
        card2.add(f3Title);
        JLabel f3Cal = new JLabel("📊 250 cal | 25g Pro", SwingConstants.CENTER);
